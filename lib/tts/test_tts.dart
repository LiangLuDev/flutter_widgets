...
class _TestTtsState extends State<TestTts> {
  ...
  initTts() {
    ...
    flutterTts.setProgressHandler((text, int start, int end, word) {
      print('setProgressHandler : start : $start  - end : $end');
      progress = ((start/end)*100) as int;
      setState(() {
